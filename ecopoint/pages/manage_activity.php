        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                ...
                <form method="post" class="d-flex gap-2">
                    ...
                    <?php if (isset($_POST['search']) || isset($_POST['search_name'])): ?>
                        <a href="index.php?page=manage_activity" class="btn btn-sm btn-outline-secondary">
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            if (!empty($_POST['search_name'])) {
                                ...
                                if ($search_condition == "") {
                                    $search_condition = "WHERE (users.firstname LIKE ? OR users.lastname LIKE ? OR CONCAT(users.firstname, ' ', users.lastname) LIKE ?)";
                                    $params[] = $search_name;
                                    $params[] = $search_name;
                                    $params[] = $search_name;
                                    $types = "sss";
                                } else {
                                    $search_condition .= " AND (users.firstname LIKE ? OR users.lastname LIKE ? OR CONCAT(users.firstname, ' ', users.lastname) LIKE ?)";
                                    $params[] = $search_name;
                                    $params[] = $search_name;
                                    $params[] = $search_name;
                                    $types .= "sss";
